...
function App() {
  ...
  function setColor(){
    ...
    document.documentElement.style.setProperty('--color-logo',newColor);
  }
  ...
  function setColorFromSliders(){
    ...
    document.documentElement.style.setProperty('--color-logo',"rgb("+red+","+green+","+blue+","+alpha+")");

    document.getElementById("red-val").innerText = red;
    document.getElementById("green-val").innerText = green;
    document.getElementById("blue-val").innerText = blue;
